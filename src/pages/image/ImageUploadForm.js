  ...
  render() {
    ...
    return (
      <>
        { modal.isOpen ? (
          <div>
            <div role="presentation" className="wds-modal__overlay" onClick={modal.close} onKeyDown={(e) => this.onKeyDown(e)} />
            <div className="wds-modal__modal">
              ...
              <div className="content">
                ...
                <p>Contents</p>
                <textarea className="wds-image__upload_contents" name="contents" value={upload.contents} onChange={(e) => this.onChangeText(e)} />
              </div>
              <div className="button-wrap">
                <button type="button" className="wds-image__upload_button" onClick={this.onClick}>Upload</button>
              </div>
            </div>
          </div>
        ) : null}
