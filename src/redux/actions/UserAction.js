...
export const UserTypes = {
  ...
  GET_UESR_REQUEST: "userReducers/get_user_request",
  GET_UESR_SUCCESS: "userReducers/get_user_success",
  UPDATE_USER: "userReducers/update_user"
};
...
export const getUser = idx => ({
  type: UserTypes.GET_UESR_REQUEST,
  payload: {
    idx
  }
});
...
export const getUserSuccess = ({ user }) => ({
  type: UserTypes.GET_UESR_SUCCESS,
  payload: {
    user
  }
});
